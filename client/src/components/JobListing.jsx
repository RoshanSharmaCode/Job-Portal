    ...
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      <div className="w-full lg:w-1/4 bg-white px-4">
        ...
        <button
          ...
          className="px-6 py-1.5 rounded border border-gray-400 lg:hodden"
        >
      ...
      {/* Job Listing Section */}
      <section className="w-full lg:w-3/4 text-gray-800 mx-lg:px-4">
          ...
          <div className="flex justify-center items-center space-x-4 mt-10">
            ...
            <a href="#job-list">
              <img
                onClick={() =>
                  setCurrentPage(
                    Math.min(Math.ceil(filterJobs.length / 6), currentPage + 1),
                  )
                }
