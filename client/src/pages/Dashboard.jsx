  ...
  return (
    <div className='min-h-screen'>
        ...
        <div className='shadow py-4'>
            <div className='px-5 flex justify-between items-center'>
                ...
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden'>Welcome, Roshan</p>
                    <div className='relative group'>
                        ...
                        <div className='absolute hidden group-hover:block top-0 right-0 text-black rounded pt-12'>
                            <ul className='list-none m-0 p-2 bg-white rounded-md border text-sm border-gray-300'>
        ...
        <div className='flex items-start'>
            ...
            <div className='inline-block min-h-screen border-r-2 text-gray-200'>
